defmodule BezirkeWeb.EventControllerTest do
  use BezirkeWeb.ConnCase

  import Bezirke.EventsFixtures

  @create_attrs %{label: "some label", description: "some description", started_at: ~U[2024-04-04 19:52:00Z], uuid: "7488a646-e31f-11e4-aace-600308960662", ended_at: ~U[2024-04-04 19:52:00Z]}
